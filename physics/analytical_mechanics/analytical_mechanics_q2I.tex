\begin{question}
	...
	Em coordenadas cilíndricas $(\rho, \phi, z)$, essa espiral pode ser descrita por $\rho = z$ e $\phi = -z$. % <---
	Utilize as equações de Euler-Lagrange para mostrar que essa conta, quando sujeita à ação da gravidade, tem seu movimento regido pela equação $(1 + z^2)\ddot z + z\dot z^2 + 10 = 0$. % <---
	...
	\begin{solution}
		...
		Mas, do enunciado, $\rho = az$ e $\phi = -bz$ (com $a = 1$ e $b = 1$). % <---
		...
		Usando os valores $a = 1$, $b = 1$ e $g = 10$, obtemos a equação do movimento desejada: % <---
		$(1 + z^2)\ddot z + z\dot z^2 + 10 = 0$. % <---
