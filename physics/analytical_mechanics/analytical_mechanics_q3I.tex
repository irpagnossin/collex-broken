\begin{question}
	...
	\begin{enumerate}
		...
		\item Determine a aceleração do objeto $1$ para o caso em que $m_1 = \measure{2.00}{kg}$, $m_2 = \measure{1.50}{kg}$, $m_3 = \measure{0.100}{kg}$ e $\varphi = \measure{30.0}{\degree}$.
	...
	\begin{answer}
		\begin{enumerate}
			\item $\left(m_1 + \frac{3}{4}m_2 + \frac{1}{4}m_3\right)\ddot x_1 - m_1 g + m_2 g \sin \varphi = 0$
			\item $\ddot x_1 = \measure{3.97}{m/s^2}$ (\ie, o objeto 1 desce com aceleração de \measure{3.97}{m/s^2})
			\item \measure{9.92e-3}{N.m}
		\end{enumerate}
	\end{answer}
	...
	\begin{solution}
		\begin{enumerate}
			...
			Finalmente, aplicando os valores de $m_1$, $m_2$, $m_3$, $\varphi$ e $g$ do enunciado, obtemos o resultado desejado: $\ddot x_1 = \measure{3.97}{m/s^2}$.
			...
			Então, $\tau_3 = \half m_3 R \ddot x_1 = \measure{9.92e-3}{N.m}$, onde usamos o valor de $\ddot x_1$ encontrado no item anterior.
		\end{enumerate}
	\end{solution}
\end{question}