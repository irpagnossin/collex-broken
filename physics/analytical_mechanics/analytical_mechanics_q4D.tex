\begin{question}
	...
	Enquanto curtia o passeio ao lado de Beltrano (cada volta durava \measure{20.0}{s}), que estava num dos carros de bombeiro, a \measure{9.00}{m} de distância do centro, ele notou que Sicrano estava escorregando do cavalo, que localizava-se na mesma radial, mas a \measure{7.00}{m} do centro (veja a figura).
	...
	\begin{answer}
		\measure{80.1}{N} tangencial, no sentido do movimento do carrossel.
	\end{answer}
