\begin{question}
	...
	Em coordenadas cilíndricas $(\rho, \phi, z)$, essa espiral pode ser descrita por $\rho = 4z$ e $\phi = -2z$. % <---
	Utilize as equações de Euler-Lagrange para mostrar que essa conta, quando sujeita à ação da gravidade, tem seu movimento regido pela equação $(17 + 64z^2)\ddot z + 64z\dot z^2 + 10 = 0$. % <---
	...
	\begin{solution}
		...
		Mas, do enunciado, $\rho = az$ e $\phi = -bz$ (com $a = 4$ e $b = 2$). % <---
		...
		Usando os valores $a = 4$, $b = 2$ e $g = 10$, obtemos a equação do movimento desejada: % <---
		$(17 + 64z^2)\ddot z + 64z\dot z^2 + 10 = 0$. % <---
