\begin{question}
	...
	\begin{answer}
		\begin{enumerate}
			...
			\item $\ddot x_1 = -\measure{2.45}{m/s^2}$ (\ie, o objeto 1 sobe com aceleração de \measure{2.45}{m/s^2}) % <--
			\item \measure{1.84e-2}{N.m} % <--
		\end{enumerate}
	\end{answer}
	...
	\begin{solution}
		\begin{enumerate}
			...
			Portanto, a intensidade do torque aplicado sobre a polia é de \measure{1.84e-2}{N.m}. % <--
		\end{enumerate}
	\end{solution}
\end{question}