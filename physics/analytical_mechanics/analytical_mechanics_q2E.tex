\begin{question}
	...
	Em coordenadas cilíndricas $(\rho, \phi, z)$, essa espiral pode ser descrita por $\rho = \frac{3}{2}z$ e $\phi = -\frac{2}{3}z$. % <---
	Utilize as equações de Euler-Lagrange para mostrar que essa conta, quando sujeita à ação da gravidade, tem seu movimento regido pela equação $(\frac{13}{4} + z^2)\ddot z + z\dot z^2 + 10 = 0$. % <---
	...
	\begin{solution}
		...
		Mas, do enunciado, $\rho = az$ e $\phi = -bz$ (com $a = \frac{3}{2}$ e $b = \frac{2}{3}$). % <---
		...
		Usando os valores $a = \frac{3}{2}$, $b = \frac{2}{3}$ e $g = 10$, obtemos a equação do movimento desejada: % <---
		$(\frac{13}{4} + z^2)\ddot z + z\dot z^2 + 10 = 0$. % <---
