\begin{question}
	...
	Determine a intensidade e o sentido dessa força, sabendo que Fulano tem massa de \measure{90.0}{kg}.

	\begin{answer}
		\measure{113}{N} tangencial, no sentido do movimento do carrossel.
	\end{answer}
