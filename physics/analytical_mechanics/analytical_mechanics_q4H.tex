\begin{question}
	...
	Enquanto curtia o passeio ao lado de Beltrano (cada volta durava \measure{25.0}{s}), que estava num dos carros de bombeiro, a \measure{8.00}{m} de distância do centro, ele notou que Sicrano estava escorregando do cavalo, que localizava-se um pouco mais à frente (veja a figura).
	...
	Determine a intensidade e o sentido dessa força, sabendo que Fulano tem massa de \measure{100}{kg}.

	\centeredfigure{0.5\textwidth}{20180804_213553}

	\begin{answer}
		\measure{50.3}{N} no sentido radial, para fora.
	\end{answer}
