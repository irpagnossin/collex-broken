\begin{question}
	...
	Enquanto curtia o passeio ao lado de Beltrano (cada volta durava \measure{25.0}{s}), que estava num dos carros de bombeiro, a \measure{9.00}{m} de distância do centro, ele notou que Sicrano estava escorregando do cavalo, que localizava-se um pouco mais à frente (veja a figura).
	Ao mover-se para ajudá-lo, a \measure{2.00}{m/s} (medido com relação à plataforma girante do carrossel), Fulano sentiu uma força estranha que o desviava de seu objetivo.
	...
	\begin{answer}
		\measure{100}{N} no sentido radial, para fora.
	\end{answer}
