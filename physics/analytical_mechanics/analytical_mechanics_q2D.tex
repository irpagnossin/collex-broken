\begin{question}
	...
	Em coordenadas cilíndricas $(\rho, \phi, z)$, essa espiral pode ser descrita por $\rho = 3z$ e $\phi = -3z$. % <---
	Utilize as equações de Euler-Lagrange para mostrar que essa conta, quando sujeita à ação da gravidade, tem seu movimento regido pela equação $(10 + 81z^2)\ddot z + 81z\dot z^2 + 10 = 0$. % <---
	...
	\begin{solution}
		...
		Mas, do enunciado, $\rho = az$ e $\phi = -bz$ (com $a = 3$ e $b = 3$). % <---
		...
		Usando os valores $a = 3$, $b = 3$ e $g = 10$, obtemos a equação do movimento desejada: % <---
		$(10 + 81z^2)\ddot z + 81z\dot z^2 + 10 = 0$. % <---
