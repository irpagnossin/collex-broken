\begin{question}
	\newcommand\HEIGHT{\measure{5.00}{m}}
	\newcommand\MASS{\measure{10.0}{kg}}
	\newcommand\FORCE{\measure{990}{N}}
	\newcommand\DURATION{\measure{0.100}{s}}
	...
	\begin{compactdesc}
		\item[Observação:] considere que a aceleração da gravidade é de \GRAVITY.
	\end{compactdesc}

	\begin{answer}
		\begin{enumerate}
			\item \measure{9.90}{m/s}
			\item \measure{99.0}{kg.m/s} ou \measure{-99.0}{kg.m/s} (o sinal não é importante aqui)
			%\item Veja a solução.
		\end{enumerate}
	\end{answer}
	...
	\begin{solution}
		\begin{enumerate}
			...
			%Finalmente, utilizando $\Delta p = \measure{99.0}{kg.m/s}$ (item anterior) e $\Delta t = \DURATION$, concluimos que $\langle F\rangle = 99 / 0,1 = \measure{990}{N}$.
		\end{enumerate}
	\end{solution}
\end{question}
