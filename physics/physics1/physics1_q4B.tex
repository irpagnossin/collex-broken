\begin{question}
	...
	Agora, suponha que num teste como esse você chegue à conclusão de que um projétil de \measure{10}{g} é disparado contra o bloco de madeira, de \measure{10}{kg}, com velocidade de \measure{200.2}{m/s}.
	Nesse caso, qual foi a altura $h$ medida por você?
	Para responder essa pergunta, considere que a aceleração da gravidade é de \measure{10}{m/s^2} e que a massa dos fios que suspendem o bloco de madeira são desprezíveis.
